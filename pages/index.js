...
- contact (Установление контакта) — проблемы с первым впечатлением, приветствием, расположением клиента
- needs (Выявление потребностей) — не знает что нужно клиенту, клиент не раскрывается, не умеет задавать вопросы
- presentation (Презентация) — клиент слушает но не заинтересован, не знает как показать ценность
- objections (Отработка возражений) — клиент говорит дорого, не сейчас, подумаю, сравнивает с конкурентами
- closing (Закрытие сделки) — клиент уходит думать, не решается купить, менеджер боится попросить купить

Дай развёрнутый разбор в JSON:
{"stage":"needs","stageLabel":"Выявление потребностей","why":"Почему возникает эта проблема (3-4 предложения)","mistake":"Главная ошибка менеджеров в этой ситуации (2-3 предложения)","phrases":["Готовая фраза 1","Готовая фраза 2","Готовая фраза 3","Готовая фраза 4"],"tip":"Главный совет что делать по-другому (2-3 предложения)"}
Не обучай продажам через кредиты и рассрочки от банков.
ТОЛЬКО JSON без markdown.`,

  kz: `Сен тәжірибелі сату жаттықтырушысысың. Менеджер сату мәселесін сипаттады.

Сату кезеңін ДӘЛМЕ-ДӘЛ анықта:
- contact (Байланыс орнату) — бірінші әсер, сәлемдесу, клиентпен тіл табысу мәселесі
- needs (Қажеттіліктерді анықтау) — клиентке не керектігін білмейді, клиент ашылмайды
- presentation (Презентация) — клиент тыңдайды бірақ қызықпайды, құндылықты көрсете алмайды
- objections (Қарсылықтарды өңдеу) — клиент қымбат дейді, ойланамын дейді, бәсекелеспен салыстырады
- closing (Мәмілені жабу) — клиент ойланып кетеді, шешім қабылдамайды, менеджер сұрауға қорқады

Толық талдауды JSON берсін:
{"stage":"needs","stageLabel":"Қажеттіліктерді анықтау","why":"Проблема неліктен туындайды (3-4 сөйлем қазақша)","mistake":"Менеджерлердің басты қатесі (2-3 сөйлем қазақша)","phrases":["Дайын жауап 1","Дайын жауап 2","Дайын жауап 3","Дайын жауап 4"],"tip":"Басты кеңес (2-3 сөйлем қазақша)"}
Банктік кредит немесе бөліп төлеу арқылы сату үйретпе.
